...
.fizztrackerwrap, .fizzhistorywrap {position: relative; max-width: 70%; margin: 31px auto; padding: 10px 25px; color: var(--whitepost); outline: 1px solid var(--border); outline-offset: 15px;}
